...
DO_API(uint32_t, il2cpp_array_length, (_Il2CppArray * array));
DO_API(uint32_t, il2cpp_array_get_byte_length, (_Il2CppArray * array));
DO_API(_Il2CppArray*, il2cpp_array_new, (Il2CppClass * elementTypeInfo, il2cpp_array_size_t length));
DO_API(_Il2CppArray*, il2cpp_array_new_specific, (Il2CppClass * arrayTypeInfo, il2cpp_array_size_t length));
DO_API(_Il2CppArray*, il2cpp_array_new_full, (Il2CppClass * array_class, il2cpp_array_size_t * lengths, il2cpp_array_size_t * lower_bounds));
...
DO_API(PropertyInfo*, il2cpp_class_get_property_from_name, (Il2CppClass * klass, const char *name));
...
DO_API(void, il2cpp_type_get_name_chunked, (Il2CppType * type, void(*chunkReportFunc)(void* data, void* userData), void* userData));
...
DO_API(uint32_t, il2cpp_class_get_data_size, (Il2CppClass * klass));
DO_API(void*, il2cpp_class_get_static_field_data, (Il2CppClass * klass));
...
DO_API(void, il2cpp_native_stack_trace, (Il2CppException * ex, uintptr_t** addresses, int* numFrames, char** imageUUID, char** imageName));
...
DO_API(const char*, il2cpp_method_get_name, (MethodInfo * method));
...
DO_API(const char*, il2cpp_method_get_param_name, (MethodInfo * method, uint32_t index));
...
DO_API(const char*, il2cpp_type_get_name, (Il2CppType * type));
...
DO_API(const char*, il2cpp_type_get_assembly_qualified_name, (Il2CppType * type));
DO_API(bool, il2cpp_type_is_static, (Il2CppType * type));
DO_API(bool, il2cpp_type_is_pointer_type, (Il2CppType * type));
...
DO_API(const char*, il2cpp_image_get_filename, (Il2CppImage * image));
...
// Debug metadata
DO_API(bool, il2cpp_debug_get_method_info, (MethodInfo*, Il2CppMethodDebugInfo * methodDebugInfo));
...
DO_API(_Il2CppArray*, il2cpp_custom_attrs_construct, (Il2CppCustomAttrInfo * cinfo));
